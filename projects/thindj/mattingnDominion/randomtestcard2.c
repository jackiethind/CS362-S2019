...
int customSmithyTest(int choice1, int choice2, int choice3, struct gameState *G, int handPos, int* bonus) {
    struct gameState testG;
    memcpy(&testG, G, sizeof(struct gameState));
    int returnVal = cardEffect(smithy, choice1, choice2, choice3, &testG, handPos, bonus);
...
int main() {
    ...
    for (int i = 0; i < 800; i++) {
        ...
        customSmithyTest(choice1, choice2, choice3, &G, handPos, bonus);
    }
